...
def parameter_parser():
    ...
    parser.add_argument("--sinkhorn-iter",
                        type=int,
                        default=10,
                        help="The number of iterations of Sinkhorn.")
    parser.add_argument("--sinkhorn-temp",
                        type=float,
                        default=0.1,
                        help="Kernel Matrix temperature of Sinkhorn.")
    parser.add_argument("--sinkhorn-eps",
                        type=float,
                        default=1e-8,
                        help="Avoiding illegal division of Sinkhorn.")
