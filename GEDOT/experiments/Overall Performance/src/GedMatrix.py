...
class GedMatrixModule(torch.nn.Module):
    ...
    def init_weight_matrix(self):
        ...
        torch.nn.init.xavier_uniform_(self.weight_matrix)#初始化函数
    ...
    #embedding1和2分别代表两个图的feature embedding矩阵
    def forward(self, embedding_1, embedding_2):
        ...
        matrix = torch.matmul(embedding_1, self.weight_matrix) #weight_matrix有k个
